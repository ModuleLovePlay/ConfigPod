...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModuleLovePlay/ConfigPod"
  ...
  s.source       = { :git => "https://github.com/ModuleLovePlay/ConfigPod.git", :tag => s.version.to_s }
  ...
  s.source_files  = "ConfigPod/ConfigPod/**/*.{h,m}"
